...
pub fn config(conf: &mut web::ServiceConfig) {
    let scope = web::scope("/api")
            ...
            .service(web::scope("/system")
                ...
                .route("/{system_id}/device/{device_id}", web::post().to(system_handler::system_device_add))
                .route("/{system_id}/device/{device_id}", web::delete().to(system_handler::system_device_delete))
